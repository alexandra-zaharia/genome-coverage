...
/**
 * La classe {@code GenomesBrowseListener} implémente l'interface
 ...
 * fichier d'entrée multi-fasta contenat les génomes.
 */
public class GenomesBrowseListener implements ActionListener {
    /**
     ...
     */
    public GenomesBrowseListener(GUI gui) {
        this.gui = gui;
    }
     ...
     * permettant de choisir le fichier d'entrée multi-fasta contenat les
     * génomes.
     * <p>
     ...
     * <p>
     * Si le fichier contenant les <i>reads</i> a également été spécifé, le 
