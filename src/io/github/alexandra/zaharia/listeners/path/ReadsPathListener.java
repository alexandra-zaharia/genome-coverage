...
/**
 * La classe {@code ReadsPathListener} implémente l'interface
 ...
 * afficher le chemin vers le fichier d'entrée de type FastQ contenant les
 * <i>reads</i>.
 */
public class ReadsPathListener implements DocumentListener {
    /**
     ...
     */    
    public ReadsPathListener(GUI gui) {
     ...
     * le champ de texte correspondant au chemin vers le fichier FastQ.
     * <p>
     * Si la longueur du chemin spécifié pour le fichier multi-fasta n'est pas
     * nulle, le bouton permettant de lancer la recherche sera activé.
     */
